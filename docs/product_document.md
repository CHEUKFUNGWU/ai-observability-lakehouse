...
| 质量评测 | evaluation judgment | feature judgment DWS、Prompt 关联 | 已实现 |
...
当前服务层共有 44 张物理表：12 DWD、16 DWS、7 DIM、9 ADS。重点面向用户的输出包括：
...
5. 在 Gravitino catalog 基础上补齐 44 表的 owner、description、retention、lineage 和变更审计元数据。
